...
from navier_stokes_voigt.processing.load_dump import load_txt, dump_txt
...
class TemplateResolver:
    ...
    def _resolve_heat_FEM(cfg: RunConfig):
        ...
        return {
            ...
            "solver_path": "navier_stokes_voigt.solvers_FEM.heat_2d.solver",
        }
    ...
    def _resolve_heat_spec(cfg: RunConfig):
        ...
        if cfg.mms:
            return {
                ...
                "solver_path": "navier_stokes_voigt.solvers_spectral.heat_2d.solver_MMS",
            }
        ...
        return {
            ...
            "solver_path": "navier_stokes_voigt.solvers_spectral.heat_2d.solver",
        }
    ...
    def _resolve_ns_FEM(cfg: RunConfig):
        ...
        if cfg.mms:
            return {
                ...
                "solver_path": "navier_stokes_voigt.solvers_FEM.navier_stokes_2d.solver_MMS",
            }
        ...
        return {
            ...
            "solver_path": "navier_stokes_voigt.solvers_FEM.navier_stokes_2d.solver",
        }
    ...
    def _resolve_ns_spec(cfg: RunConfig):
        ...
        if cfg.mms:
            return {
                ...
                "solver_path": "navier_stokes_voigt.solvers_spectral.navier_stokes_2d.solver_MMS",
            }
        ...
        return {
            ...
            "solver_path": "navier_stokes_voigt.solvers_spectral.navier_stokes_2d.solver",
        }
    ...
    def _resolve_nsv_FEM(cfg: RunConfig):
        ...
        if cfg.mms:
            return {
                ...
                "solver_path": "navier_stokes_voigt.solvers_FEM.navier_stokes_voigt_2d.solver_MMS",
            }
        ...
        return {
            ...
            "solver_path": "navier_stokes_voigt.solvers_FEM.navier_stokes_voigt_2d.solver",
        }
    ...
    def _resolve_nsv_spec(cfg: RunConfig):
        ...
        if cfg.mms:
            return {
                ...
                "solver_path": "navier_stokes_voigt.solvers_spectral.navier_stokes_voigt_2d.solver_MMS",
            }
        ...
        return {
            ...
            "solver_path": "navier_stokes_voigt.solvers_spectral.navier_stokes_voigt_2d.solver",
        }
    ...
    def _resolve_compare_spec(cfg: RunConfig):
        ...
        return {
            ...
            "solver": f"{TemplateResolver.BASE}/solver_parameters/any_spec.yaml",
            "ufl": f"{TemplateResolver.BASE}/user_expr/ns_spec.yaml",
            "solver_path": "navier_stokes_voigt.solvers_spectral.compare_2d.solver",
        }
